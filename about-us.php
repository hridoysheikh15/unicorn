            ...
            <div class="identity-content">
                <div class="identity-paragraph-1">
                    ...
                    <div class="identity-paragraph-body">
                        ...
                        of incredible freelance talent for all your software development needs.
                    </div>
                </div>
                <hr>
                <div class="identity-paragraph-2">
                    <div class="identity-paragraph-sub-body pe-md-1">
                        ...
                        <p>
                            Accelerate innovation with world-class tech teams. We help businesses elevate their
                            value.
                        </p>
                    </div>
    ...
    <div class="project-history">
        <div class="project-history-box">
            <div class="project-number">
                ...
                <div class="project-item">
                    <h1>738+</h1>
                    <p class="text-capitalize">website</p>
                </div>
                <div class="project-item">
                    <h1>1367+</h1>
                ...
                <div class="emp-card">
                    <div class="emp-card-item">
                        <div class="emp-card-detail">
                            <img src="../image/emp-2.png" alt="emp">
                            <div class="img-box"></div>
                            <div class="emp-card-details">
                                <div class="emp-card-content p-lg-4">
                        ...
                        <div class="emp-card-detail">
                            <img src="../image/avatar.png" alt="emp">
                            <div class="img-box"></div>
                            <div class="emp-card-details">
                                <div class="emp-card-content p-lg-4">
                                    <h4 class="text-uppercase">
                    ...
                    <div class="emp-card">
                        <div class="emp-card-item">
                            <div class="emp-card-detail">
                                <img src="../image/emp-3.jpg" alt="emp">
                                <div class="img-box"></div>
                                <div class="emp-card-details">
                                    <div class="emp-card-content p-lg-4">
                                        <h4 class="text-uppercase">
                ...
                <div class="emp-card">
                    <div class="emp-card">
                        <div class="emp-card-item">
                            ...
                            <div class="emp-card-detail">
                                <img src="../image/emp-5.jpg" alt="emp">
                                <div class="img-box"></div>
                                <div class="emp-card-details">
                                    <div class="emp-card-content p-lg-4">
                                        <h4 class="text-uppercase">
